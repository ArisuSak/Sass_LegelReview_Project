...
http://127.0.0.1:8000/api/login-AuthenticatedSessionController
Route::post('/login-AuthenticatedSessionController', [AuthenticatedSessionController::class,'store']);
