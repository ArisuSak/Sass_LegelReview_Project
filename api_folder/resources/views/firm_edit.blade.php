@extends('master.master')
    ...
    <div class="control-group">
        <input type="text" class="form-control" id="firm_name" name="firm_name" placeholder="Company Name" value="{{ $firm->name }}" />
        <p class="help-block text-danger"></p>
    </div>
    <div class="control-group">
        <input type="email" class="form-control" id="firm_email" name="firm_email" placeholder="Email" value="{{ $firm->email }}" />
        <p class="help-block text-danger"></p>
    </div>
    <div class="control-group">
        <input type="tel" class="form-control" id="firm_phonenumber" name="firm_phonenumber" placeholder="Phone number" value="{{ $firm->phonenumber }}" />
        <p class="help-block text-danger"></p>
    </div>
    <div class="control-group">
        <input type="tel" class="form-control" id="firm_address" name="firm_address" placeholder="Address" value="{{ $firm->address }}" />
        <p class="help-block text-danger"></p>
    </div>
    ...
    <div class="control-group">
        <textarea class="form-control" id="firm_information" name="firm_information" placeholder="Information">{{ $firm->information }}</textarea>
        <p class="help-block text-danger"></p>
    </div>
