            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    <div class="navbar-nav ml-auto">
                        ...
                        <a href="se/rvice" class="nav-item nav-link">Service</a>
                        <a href="fe/ature" class="nav-item nav-link">Feature</a>
                        <a href="ad/visor" class="nav-item nav-link">Advisor</a>
                        <a href="r/eview" class="nav-item nav-link">Review</a>
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle active" data-toggle="dropdown">Pages</a>
                            <div class="dropdown-menu">
                                <a href=/"blog" class="dropdown-item">Blog Page</a>
                                <a href="s/ingle" class="dropdown-item">Single Page</a>
                            </div>
                        </div>
                        <a href="co/ntact" class="nav-item nav-link">Contact</a>
                    </div>
                </div>
            </div>
        </div>
