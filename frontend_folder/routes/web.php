...
Route::get('/', [FirmController::class, 'showFirm'])->name('index');
Route::post('/', [FirmController::class, 'storeData'])->name('index');
...
Route::post('ratings/submit/{firm}', [RatingController::class, 'submitRating'])->name('ratings.submit');
