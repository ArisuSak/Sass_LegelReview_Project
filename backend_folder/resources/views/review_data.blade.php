...
<div class="row">
  <div class="col-lg-12">
    <h5 class="card-title fw-semibold mb-4">Review Data</h5>
        ...
        <table class="table text-nowrap mb-0 align-middle small-table">
          <thead class="text-dark fs-4">
            <tr class="sticky-top">
              ...
              <th class="border-bottom-0 small-cell">
                <h6 class="fw-semibold mb-0">Firm</h6>
              </th>
              <th class="border-bottom-0 small-cell">
    ...
    <tr>
        ...
        <td class="border-bottom-0 small-cell">
            <h6 class="fw-semibold mb-0">{{ $item->firm_id }}</h6>
        </td>
        <td class="border-bottom-0 small-cell">
            <h6 class="badge bg-success rounded-3 fw-semibold user"><strong>{{ $item->user->name ?? 'Unknown User' }}</strong></h6>
            <td>
                @for($i = 1; $i <= 5; $i++)
                    @if($i <= $item->rating)
