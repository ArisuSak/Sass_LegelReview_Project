...
{
    // Retrieve all firms and order them by the number of reviews in descending order
    $firms = Firm::withCount('ratings')->orderByDesc('reviews_count')->get();
    ...
    // Return the ranked firms as JSON response
    return response()->json($rankedFirms);
}
...
public function show(Request $request)
{
    ...
    // return response()->json(['firm' => $firm, 'services' => $services]);
