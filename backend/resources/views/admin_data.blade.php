...
<div class="row">
  <div class="col-lg-12">
    <h5 class="card-title fw-semibold mb-4">Admin Data</h5>
    ...
    <tr>
        ...
        <td class="border-bottom-0 small-cell">
        @if($item->active && !$item->hasRole('super_admin') && $item->id !== auth()->id())
        ...
        @elseif(!$item->active && !$item->hasRole('super_admin') && $item->id !== auth()->id())
